...
3. $\dfrac{dn}{dt} = (0.2*sin(t)+0.7*cos(t)n(t))(N-n(t))$
...
![График распространения рекламы для случая 1](image/1.png){#fig:001 width=80%}
...
maximum(dev)
```
Получим значение `278564.53094499157`.

Далее найдем индекс этого элемента в векторе `dev`.

```Julia
findall(x -> x == 278564.53094499157, dev)
...
![График распространения рекламы для случая 2](image/2.png){#fig:002 width=80%}
...
![График распространения рекламы для случая 3](image/3.png){#fig:003 width=80%}
...
![График распространения рекламы для случая 1](image/4.png){#fig:004 width=80%}
...
![График распространения рекламы для случая 2](image/5.png){#fig:005 width=80%}

Давайте посмотрим на график (рис. @fig:006) изменения производной с течением времени. На графике четко виден максимум.

![График изменения производной с течением времени](image/6.png){#fig:006 width=80%}
...
![Максимальное значение скорости распространения рекламы](image/7.png){#fig:007 width=80%}
...
![График распространения рекламы для случая 3](image/8.png){#fig:008 width=80%}
