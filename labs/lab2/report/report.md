...
![График для второго случая (траектория лодки и траектория катера)](image/5.png){#fig:003 width=70%}
...
![ОДУ для первого случая](image/3.png){#fig:005 width=70%}
...
![ОДУ для второго случая](image/6.png){#fig:007 width=70%}
